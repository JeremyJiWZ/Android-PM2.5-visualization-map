...
public class PageSectionFragment extends Fragment {
    ...
    private static final String URL ="http://www.pm25.com/news/cat/";
    ...
    public void getImageData(int pageNum) {
        if (Validator.isEffective(mCategoryId)) {
            final String pageUrl = URL + mCategoryId + "?pager=" + pageNum;
    ...
    public void showContent(List<ImageInfo> tempList) {
        if (tempList != null && tempList.size() > 0) {
            ...
            Toast.makeText(mContext, "已无更多推送", Toast.LENGTH_SHORT).show();
        }
    ...
    public class ListViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                viewHolder.tv_content = (TextView) view.findViewById(R.id.img_content);
            ...
            String content=imgInfo.getImgContent();
            final String weblink=imgInfo.getImgLink();
